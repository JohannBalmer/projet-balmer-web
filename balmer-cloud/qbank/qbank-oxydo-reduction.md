...
**Options**
- A. +6 — obtenu en posant que la somme des d.o. égale la charge de l'ion, avec O = −2 : d.o.(S) + 4×(−2) = −2
...
**Feedback correct**
Avec O = −2 et la somme des d.o. égale à la charge de l'ion (ici −2) : d.o.(S) + 4×(−2) = −2, donc d.o.(S) = −2 + 8 = +6.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : C'est une confusion fréquente et bien documentée entre le degré d'oxydation (une charge fictive, répartie atome par atome selon les règles) et la charge réelle de l'ion (une propriété globale de l'ensemble $\ce{SO4^{2-}}$). La charge −2 de l'ion n'est pas « portée » par un seul atome — elle résulte de la somme des d.o. de tous les atomes, et le soufre a lui-même un d.o. bien différent (+6) de la charge de l'ion.
- Si C : Le raisonnement en « charge par liaison rapportée aux électrons de valence » n'est pas la méthode du d.o. — on applique la règle de la somme des d.o. sur l'ensemble du groupe, pas un décompte liaison par liaison des électrons de valence disponibles.
...
**Options**
- A. +5 — obtenu en posant que la somme des d.o. égale la charge de l'ion, avec O = −2 : d.o.(N) + 3×(−2) = −1
...
**Feedback correct**
Avec O = −2 et la somme des d.o. égale à la charge de l'ion (ici −1) : d.o.(N) + 3×(−2) = −1, donc d.o.(N) = −1 + 6 = +5.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : Même confusion que pour $\ce{SO4^{2-}}$ : la charge −1 de l'ion nitrate est une propriété de l'ensemble de l'ion (résultat de la somme des d.o. sur tous les atomes), pas une valeur directement transférable à l'azote seul. L'azote a ici un d.o. de +5, très différent de la charge −1 de l'ion.
- Si C : Le d.o. ne se calcule pas comme un forfait « +1 par liaison » — il faut appliquer la règle de la somme des d.o. égale à la charge de l'ion sur l'ensemble du groupe.
...
- D. Impossible à calculer sans connaître la structure développée — la règle de la somme des d.o. ne s'applique pas à un ion contenant deux atomes identiques

**Réponse correcte** : A

**Feedback correct**
Avec O = −2 : 2×d.o.(S) + 3×(−2) = −2, donc d.o.(S) = +2 en moyenne. Mais les deux atomes de soufre du thiosulfate n'ont pas le même environnement (l'un est entouré d'oxygènes comme dans un sulfate, l'autre est lié uniquement à l'autre soufre) — leurs d.o. réels diffèrent (+5 et −1 typiquement), et +2 n'est que leur moyenne arithmétique, pas la valeur individuelle de chacun.
...
- Si C : La charge de l'ion (−2) n'est pas répartie directement sur un seul type d'atome — la règle de la somme des d.o. fait intervenir tous les atomes de la formule (ici aussi les trois oxygènes à −2 chacun), pas seulement le soufre.
- Si D : Cette règle s'applique très bien à partir de la formule brute, même avec des atomes identiques — elle donne cependant une moyenne, pas le détail par atome, qui nécessiterait effectivement la structure développée.
...
**Options**
- A. 0 en moyenne — mais les deux carbones ont des d.o. réels différents (+3 pour le carbone du groupe −COOH, −3 pour celui du groupe −CH3), qui se compensent exactement
...
- D. La règle de la somme des d.o. échoue ici car les deux carbones ne sont pas équivalents — il faut une méthode différente pour une molécule organique
...
- Si C : Cette règle s'applique à la somme de tous les atomes de la formule, pas à une répartition ad hoc de certains atomes vers d'autres — ce raisonnement ne correspond à aucune des règles pratiques d'attribution du d.o.
- Si D : Cette règle fonctionne parfaitement à partir de la formule brute, y compris pour des molécules organiques — elle donne toujours une moyenne quand plusieurs atomes identiques ont des environnements différents, ce qui n'est pas un échec de la méthode mais une limite inhérente à l'information contenue dans une formule brute.

**Référence manuel** : oxydo-reduction-degre-oxydation

---
id: q-degre-oxydation-symbo-t3-003
concept: degre-oxydation
sous-partie: 6A
chapitre: oxydo-reduction
niveau: DF+OS
...
**Question**
Dans quelle(s) espèce(s) suivante(s) l'atome de carbone a-t-il un degré d'oxydation de $+\text{IV}$ ?
...
**Feedback correct**
Dans $\ce{CO2}$, l'oxygène (degré $-\text{II}$) contribue pour $2 \times (-2) = -4$ ; la molécule étant neutre, le carbone vaut $+4$, soit $+\text{IV}$. Dans $\ce{CCl4}$, le chlore (degré $-\text{I}$, plus électronégatif que le carbone) contribue pour $4 \times (-1) = -4$ ; le carbone vaut donc lui aussi $+4$, soit $+\text{IV}$ — un halogène joue ici exactement le même rôle comptable que l'oxygène.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : Dans $\ce{CH4}$, c'est le carbone qui est plus électronégatif que l'hydrogène (degré $+\text{I}$) : $4 \times (+1) = +4$ côté hydrogène, donc le carbone vaut $-4$, soit $-\text{IV}$ — l'opposé de ce qui est demandé.
- Si C : Dans $\ce{CO}$, l'oxygène (degré $-\text{II}$) contribue pour $-2$ ; le carbone vaut donc $+2$, soit $+\text{II}$, pas $+\text{IV}$.
...
---
id: q-oxydant-symbo-t3-001
concept: oxydant
outils: A:oxydant, B:oxydant, C:reducteur, D:reducteur
sous-partie: 6B
chapitre: oxydo-reduction
niveau: DF+OS
r1: symbo
...
**Question**
On mélange du dichlore gazeux $\ce{Cl2}$ avec une solution contenant des ions bromure $\ce{Br-}$. Sachant que $E^\circ(\ce{Cl2/Cl-}) = +1{,}36$ V et $E^\circ(\ce{Br2/Br-}) = +1{,}06$ V, la réaction $\ce{Cl2 + 2Br- -> 2Cl- + Br2}$ est spontanée. Parmi les affirmations suivantes, lesquelles sont exactes ?

**Options**
- A. Le dichlore $\ce{Cl2}$ agit ici comme oxydant : il capte des électrons et est réduit en ions chlorure.
- B. Le dichlore $\ce{Cl2}$ ne peut pas être qualifié d'oxydant dans cette réaction, car c'est une molécule neutre et non un ion.
- C. L'ion bromure $\ce{Br-}$ agit ici comme réducteur : il cède des électrons et est oxydé en dibrome $\ce{Br2}$.
- D. L'ion bromure $\ce{Br-}$, étant chargé négativement, ne peut jamais céder d'électrons et ne peut donc pas jouer le rôle de réducteur.

**Réponse correcte** : A, C

**Feedback correct**
A. Un oxydant est l'espèce qui capte des électrons (elle est réduite) — ici $\ce{Cl2}$ passe du degré d'oxydation $0$ à $-\text{I}$, il a donc bien capté des électrons. C. Un réducteur est l'espèce qui cède des électrons (elle est oxydée) — ici $\ce{Br-}$ passe du degré d'oxydation $-\text{I}$ à $0$, il a donc bien cédé des électrons.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : La charge électrique d'une espèce n'a aucun rapport avec sa capacité à être oxydant ou réducteur — de nombreux oxydants usuels sont des molécules neutres ($\ce{Cl2}$, $\ce{O2}$, $\ce{H2O2}$...). Ce qui définit un oxydant, c'est qu'il capte des électrons (et voit son degré d'oxydation diminuer), pas sa charge de départ.
- Si C : C'est la bonne réponse.
- Si D : C'est l'erreur inverse de B : rien n'empêche une espèce chargée négativement de céder un électron supplémentaire. C'est même très courant pour les ions halogénures ($\ce{Cl-}$, $\ce{Br-}$, $\ce{I-}$), des réducteurs usuels malgré leur charge négative.
...
---
id: q-demi-reaction-symbo-t3-002
concept: demi-reaction
sous-partie: 6B
chapitre: oxydo-reduction
niveau: DF+OS
...
**Question**
Parmi les demi-équations électroniques suivantes, lesquelles sont correctement équilibrées (atomes ET charges) ?

**Options**
- A. $\ce{Cr2O7^{2-} + 14H+ + 6e- -> 2Cr^{3+} + 7H2O}$
- B. $\ce{Cr2O7^{2-} + 14H+ + 6e- -> 2Cr^{3+} + 8H2O}$
- C. $\ce{Zn -> Zn^{2+} + 2e-}$
- D. $\ce{Cu^{2+} + e- -> Cu}$
...
**Feedback correct**
A. Atomes : 2 Cr, 7 O, 14 H de chaque côté ; charges : $(-2) + 14 = +12$ à gauche moins les 6 électrons captés $= +6$, et $2 \times (+3) = +6$ à droite. C. Une seule espèce, aucun atome à vérifier ; charges : $0$ à gauche, $(+2) + (-2)$ (les 2 électrons libérés) $= 0$ à droite.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : Les atomes d'oxygène et d'hydrogène ne sont pas équilibrés — $7$ atomes d'oxygène et $14$ d'hydrogène à gauche (dans $\ce{Cr2O7^{2-}}$ et $\ce{14H+}$), contre $8$ atomes d'oxygène et $16$ d'hydrogène à droite (dans $\ce{8H2O}$) : il manque un $\ce{H2O}$ à droite, pas huit.
- Si C : C'est la bonne réponse.
- Si D : Le cuivre passe du degré d'oxydation $+\text{II}$ à $0$, ce qui nécessite de capter **2** électrons, pas 1 — avec un seul électron, la charge ne s'équilibre pas ($+2 - 1 = +1 \neq 0$).
...
---
id: q-serie-electrochimique-symbo-t3-003
concept: serie-electrochimique
sous-partie: 6B
chapitre: oxydo-reduction
niveau: DF+OS
...
**Question**
On dispose de dibrome $\ce{Br2}$ (couple $\ce{Br2/Br-}$, $E^\circ = +1{,}06$ V) que l'on met séparément en présence de chacune des espèces suivantes. Avec laquelle/lesquelles de ces espèces une réaction d'oxydoréduction spontanée peut-elle avoir lieu ?

**Options**
- A. Des ions $\ce{Fe^{2+}}$ (couple $\ce{Fe^{3+}/Fe^{2+}}$, $E^\circ = +0{,}77$ V)
- B. Des ions $\ce{Cl-}$ (couple $\ce{Cl2/Cl-}$, $E^\circ = +1{,}36$ V)
- C. Des ions $\ce{I-}$ (couple $\ce{I2/I-}$, $E^\circ = +0{,}53$ V)
- D. Du cuivre métallique $\ce{Cu}$ (couple $\ce{Cu^{2+}/Cu}$, $E^\circ = +0{,}34$ V)

**Réponse correcte** : A, C, D

**Feedback correct**
Une réaction spontanée a lieu entre l'oxydant du couple de plus haut $E^\circ$ ($\ce{Br2}$, ici) et le réducteur d'un couple de $E^\circ$ plus bas. C'est le cas pour $\ce{Fe^{2+}}$ ($0{,}77$ V), $\ce{I-}$ ($0{,}53$ V) et $\ce{Cu}$ ($0{,}34$ V) : ces trois $E^\circ$ sont inférieurs à celui de $\ce{Br2/Br-}$ ($1{,}06$ V).

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : Piège classique — même s'il s'agit aussi d'un halogénure, le couple $\ce{Cl2/Cl-}$ a un $E^\circ$ ($1{,}36$ V) supérieur à celui de $\ce{Br2/Br-}$ ($1{,}06$ V) : c'est $\ce{Cl-}$ le réducteur le plus faible ici, pas le plus fort. C'est en réalité $\ce{Cl2}$ qui pourrait oxyder $\ce{Br-}$, jamais l'inverse.
- Si C : C'est la bonne réponse.
- Si D : C'est la bonne réponse.
...
---
id: q-pile-galvanique-symbo-t3-001
concept: pile-galvanique
outils: A:pile-galvanique, B:pile-galvanique, C:force-electromotrice, D:force-electromotrice
sous-partie: 6C
chapitre: oxydo-reduction
niveau: DF+OS
r1: symbo
...
**Question**
On réalise une pile galvanique standard à partir des couples $\ce{Ag+/Ag}$ ($E^\circ = +0{,}80$ V) et $\ce{Zn^{2+}/Zn}$ ($E^\circ = -0{,}76$ V), reliés par un pont salin. Parmi les affirmations suivantes sur cette pile, lesquelles sont exactes ?

**Options**
- A. L'électrode de zinc constitue l'anode de la pile : c'est le siège de l'oxydation, $\ce{Zn -> Zn^{2+} + 2e-}$.
- B. Dans le circuit extérieur, les électrons circulent de l'électrode d'argent vers l'électrode de zinc.
- C. La force électromotrice de cette pile, dans les conditions standard, vaut $E = 0{,}80 - (-0{,}76) = 1{,}56$ V.
- D. Si l'on double simultanément les concentrations de $\ce{Ag+}$ et de $\ce{Zn^{2+}}$ tout en restant par ailleurs proche des conditions standard, la f.é.m. reste rigoureusement égale à 1,56 V.

**Réponse correcte** : A, C

**Feedback correct**
A. Le zinc, métal le moins noble ($E^\circ$ le plus bas), s'oxyde spontanément : il est bien l'anode. C. La f.é.m. standard se calcule par $E = E^\circ_{cathode} - E^\circ_{anode}$, ici $0{,}80 - (-0{,}76) = 1{,}56$ V — la cathode est toujours l'électrode au potentiel standard le plus élevé, ici l'argent.

**Feedback incorrect**
- Si A : C'est la bonne réponse — le zinc est bien l'anode.
- Si B : C'est l'inverse. Les électrons quittent l'anode (zinc, où ils sont libérés par l'oxydation) et circulent, dans le circuit extérieur, vers la cathode (argent, où ils sont consommés par la réduction) — jamais dans l'autre sens dans une pile qui fonctionne.
- Si C : C'est la bonne réponse — $1{,}56$ V est correct.
- Si D : La loi de Nernst montre que la f.é.m. dépend du quotient réactionnel $Q$, pas seulement du rapport des concentrations initiales. Ici, la réaction globale est $\ce{Zn + 2Ag+ -> Zn^{2+} + 2Ag}$, donc $Q = [\ce{Zn^{2+}}]/[\ce{Ag+}]^2$. En doublant les deux concentrations, $Q$ est divisé par 2 (le terme au carré au dénominateur pèse plus que le terme simple au numérateur) : la f.é.m. change donc légèrement, même si elle reste proche de 1,56 V — elle n'est jamais rigoureusement identique dès qu'on s'écarte des concentrations standard de 1 mol/L.
...
**Question**
Comment un générateur électrique parvient-il à inverser le sens naturel des réactions lors d'une électrolyse ?
...
---
id: q-electrolyse-symbo-t3-001
concept: electrolyse
outils: A:electrolyse, B:electrolyse, C:anode, D:anode
sous-partie: 6D
chapitre: oxydo-reduction
niveau: DF+OS
r1: symbo
...
**Question**
Un générateur électrique impose un courant à travers une solution aqueuse de chlorure de cuivre(II) $\ce{CuCl2}$, entre deux électrodes de graphite inerte. Parmi les affirmations suivantes, lesquelles sont exactes ?

**Options**
- A. Cette transformation est forcée : elle ne se produit que grâce à l'apport continu d'énergie électrique du générateur.
- B. Une fois le dépôt de cuivre amorcé, la réaction se poursuit d'elle-même même si l'on débranche le générateur, comme dans une pile.
- C. L'anode de cette électrolyse est reliée à la borne positive du générateur, et c'est pourtant bien là que se produit l'oxydation — comme dans toute anode.
- D. Puisque l'anode est toujours le siège d'une oxydation, elle est nécessairement reliée à la borne négative du générateur, comme c'est le cas dans une pile galvanique.

**Réponse correcte** : A, C

**Feedback correct**
A. Une électrolyse est par définition une transformation forcée : contrairement à la pile (spontanée), elle s'arrête dès que le générateur cesse de fournir de l'énergie. C. La définition de l'anode (siège de l'oxydation) ne change jamais — mais sa polarité, elle, s'inverse entre pile et électrolyse : ici, c'est le générateur qui impose le sens du courant, et l'anode se retrouve reliée à la borne positive.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : Une électrolyse est une transformation forcée, non spontanée : elle ne s'auto-entretient jamais. Dès que le générateur est débranché, le courant cesse et la réaction s'arrête immédiatement — à l'inverse d'une pile, qui continue de fonctionner seule tant que les réactifs ne sont pas épuisés.
- Si C : C'est la bonne réponse.
- Si D : C'est l'erreur inverse. La définition de l'anode (siège de l'oxydation) est constante, mais sa polarité dépend du dispositif : négative dans une pile (l'oxydation y est spontanée), positive dans une électrolyse (le générateur impose la polarité pour forcer l'oxydation à cette électrode). Confondre les deux polarités est l'erreur la plus fréquente sur ce point.
...
**Question**
On fait passer la même quantité d'électricité $Q$ à travers deux cellules d'électrolyse distinctes : la première contient une solution de $\ce{Cu^{2+}}$ ($M = 63{,}5$ g/mol, 2 électrons échangés par ion), la seconde une solution de $\ce{Ag+}$ ($M = 108$ g/mol, 1 électron échangé par ion). Parmi les affirmations suivantes, lesquelles sont exactes ?

**Options**
- A. La masse d'argent déposée est supérieure à la masse de cuivre déposée.
- B. Le nombre de moles d'électrons ayant circulé est le même dans les deux cellules.
- C. Le nombre de moles de cuivre déposées est supérieur au nombre de moles d'argent déposées.
- D. Si l'on double la quantité d'électricité $Q$, la masse de cuivre déposée double également.

**Réponse correcte** : A, B, D

**Feedback correct**
A. La loi de Faraday donne $m = \dfrac{QM}{nF}$ : pour $\ce{Ag}$, $M/n = 108$ ; pour $\ce{Cu}$, $M/n = \dfrac{63{,}5}{2} = 31{,}75$ — à $Q$ égal, l'argent dépose donc bien davantage en masse. B. Le nombre de moles d'électrons vaut $Q/F$, une quantité qui ne dépend ni du métal, ni de $n$ : elle est nécessairement identique dans les deux cellules puisque $Q$ est la même. D. La masse est directement proportionnelle à $Q$ dans la loi de Faraday ($m = QM/nF$, à $M$, $n$, $F$ constants) : doubler $Q$ double $m$.

**Feedback incorrect**
- Si A : C'est la bonne réponse.
- Si B : C'est la bonne réponse.
- Si C : C'est l'inverse. Le nombre de moles déposées vaut $Q/(nF)$ : pour l'argent, $n=1$, donc $Q/F$ moles ; pour le cuivre, $n=2$, donc seulement $Q/(2F)$ moles, soit deux fois moins. C'est l'argent qui est déposé en plus grand nombre de moles, précisément parce qu'il ne nécessite qu'un seul électron par ion.
- Si D : C'est la bonne réponse.
